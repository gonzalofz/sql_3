CREATE DATABASE desafio3_gonzalo_fuentes_123;
CREATE TABLE users(
  id SERIAL,
...
('dani@mail.com', 'daniel', 'rozales', 'administrador'),
('anto@mail.com', 'anto', 'fuentes', 'usuario'),
('inti@mail.com', 'inti', 'allende', 'usuario'),
('black@mail.com','oscar', 'black', 'usuario'),
('leo@mail.com', 'leo', 'yañez', 'usuario');
